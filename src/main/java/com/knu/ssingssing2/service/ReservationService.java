...
public class ReservationService {
  ...
  public ApiResponse reservation(Long scooterId, Location returnLocation,
    ...
    if (scooter == null) throw new ScooterNotFoundException("can not find scooter");
  ...
  public List<ScooterResponse> findAllAvailableReservationScootersWithModelAndLocation(String modelName,
  ...
  public List<ScooterResponse> findAllAvailableReservationScootersWithLocation(String rentalLocation,
  ...
  private List<ScooterResponse> streamData(String rentalLocation, ReservationTime time,
    ...
    List<ScooterResponse> availableScooters = scooters.stream()
